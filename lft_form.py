...
title_label = CTkLabel(master=frame1, text="lft Form", font=CTkFont('Microsoft YaHei UI Light',35,"bold",underline="true"))
...
alb_label = CTkLabel(master=frame1, text="Albumin:", font=CTkFont('Kanit Regular',20))
alb_label.place(relx=0.1,rely=0.28)
alb_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
alb_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.28)

glb_label = CTkLabel(master=frame1, text="Globulin:", font=CTkFont('Kanit Regular',20))
glb_label.place(relx=0.1,rely=0.38)
glb_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
glb_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.38)

tsp_label = CTkLabel(master=frame1, text="Total Serum Protein:", font=CTkFont('Kanit Regular',20))
tsp_label.place(relx=0.1,rely=0.48)
tsp_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
tsp_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.48)

bbt_label = CTkLabel(master=frame1, text="Bilrubin Total:", font=CTkFont('Kanit Regular',20))
bbt_label.place(relx=0.1,rely=0.58)
bbt_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
bbt_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.58)

alp_label = CTkLabel(master=frame1, text="ALP:", font=CTkFont('Kanit Regular',20))
alp_label.place(relx=0.1,rely=0.68)
alp_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
alp_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.68)

ast_label = CTkLabel(master=frame1, text="AST:", font=CTkFont('Kanit Regular',20))
ast_label.place(relx=0.1,rely=0.78)
ast_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
