...
title_label = CTkLabel(master=frame1, text="CM Form", font=CTkFont('Microsoft YaHei UI Light',35,"bold",underline="true"))
...
wbc_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
wbc_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.28)

plt_label = CTkLabel(master=frame1, text="Platelets:", font=CTkFont('Kanit Regular',20))
plt_label.place(relx=0.1,rely=0.38)
plt_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
plt_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.38)

ast_label = CTkLabel(master=frame1, text="AST level:", font=CTkFont('Kanit Regular',20))
...
ldlch_label = CTkLabel(master=frame1, text="LDL cholesterol:", font=CTkFont('Kanit Regular',20))
ldlch_label.place(relx=0.1,rely=0.58)
ldlch_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
ldlch_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.58)

tg_label = CTkLabel(master=frame1, text="Triglycerides:", font=CTkFont('Kanit Regular',20))
tg_label.place(relx=0.1,rely=0.68)
tg_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
...
hmg_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
