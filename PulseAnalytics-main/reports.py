...
report = CTk()
report.title("PulseAnalytics")
x = (report.winfo_screenwidth() - 1250) // 2
y = (report.winfo_screenheight() - 768) // 2
report.geometry(f"1250x750+{x}+{y}")
report.configure(bg="#000000")

frame1 = CTkFrame(master=report, fg_color="#EBEEF6", corner_radius=0, width=1250,height=750)
frame1.place(x=0, y=0)

select_label = CTkLabel(master=frame1, text="Select a category to compare :", font=CTkFont('Microsoft YaHei UI Light',25,"bold"),text_color="#000000")
...
form1 = CTkButton(master=frame1,text="Basic Blood Chemistry Test",font=CTkFont('Kanit Regular', 20, "bold"),fg_color="#FFFFFF",text_color="#000000",hover_color="#5FBDFF", corner_radius=100, command=bbc_cmp)
...
form5 = CTkButton(master=frame1, text="Complete Blood Count",font=CTkFont('Kanit Regular', 20, "bold"),fg_color="#FFFFFF",text_color="#000000",hover_color="#5FBDFF", corner_radius=100, command=cbc_cmp)
