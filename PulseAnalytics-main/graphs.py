...
graphs = CTk()
graphs.title("PulseAnalytics")
x = (graphs.winfo_screenwidth() - 1250) // 2
y = (graphs.winfo_screenheight() - 768) // 2
graphs.geometry(f"1250x750+{x}+{y}")
graphs.configure(bg="#000000")

frame1 = CTkFrame(master=graphs, fg_color="#EBEEF6", corner_radius=0, width=1250,height=750)
...
form1 = CTkButton(master=frame1,text="Basic Blood Chemistry Test",font=CTkFont('Kanit Regular', 20, "bold"),fg_color="#FFFFFF",text_color="#000000",hover_color="#5FBDFF", corner_radius=100,command=bbc_graph)
...
form5 = CTkButton(master=frame1, text="Complete Blood Count",font=CTkFont('Kanit Regular', 20, "bold"),fg_color="#FFFFFF",text_color="#000000",hover_color="#5FBDFF", corner_radius=100,command=cbc_graph)
