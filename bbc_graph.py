...
urea_label = CTkLabel(master=graphframe1, text="Urea:", font=CTkFont('Kanit Regular',30))
...
creatinine_label = CTkLabel(master=graphframe2, text="Creatinine:", font=CTkFont('Kanit Regular',30))
...
sodium_label = CTkLabel(master=graphframe3, text="Sodium:", font=CTkFont('Kanit Regular',30))
...
potassium_label = CTkLabel(master=graphframe4, text="Potassium:", font=CTkFont('Kanit Regular',30))
...
uric_acid_label = CTkLabel(master=graphframe5, text="Uric Acid :", font=CTkFont('Kanit Regular',30))
...
total_protein_label = CTkLabel(master=graphframe6, text="Total Protein :", font=CTkFont('Kanit Regular',30))
