...
title_label = CTkLabel(master=frame1, text="Hgb A1C Form", font=CTkFont('Microsoft YaHei UI Light',35,"bold",underline="true"))
...
a1c_label = CTkLabel(master=frame1, text="Hgb A1C:", font=CTkFont('Kanit Regular',20))
a1c_label.place(relx=0.1,rely=0.48)
a1c_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="%")
a1c_entry.place(relheight=0.08,relwidth=0.5,relx=0.4,rely=0.48)

eag_label = CTkLabel(master=frame1, text="eAG:", font=CTkFont('Kanit Regular',20))
eag_label.place(relx=0.1,rely=0.63)
eag_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="mg/dL")
