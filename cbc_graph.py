...
hmg_label = CTkLabel(master=graphframe1, text="Haemoglobin:", font=CTkFont('Kanit Regular',30))
...
rbc_label = CTkLabel(master=graphframe2, text="RBC count:", font=CTkFont('Kanit Regular',30))
...
wbc_label = CTkLabel(master=graphframe3, text="WBC count:", font=CTkFont('Kanit Regular',30))
...
Platelet_label = CTkLabel(master=graphframe4, text="Platelet count:", font=CTkFont('Kanit Regular',30))
...
hematocrit_label = CTkLabel(master=graphframe5, text="Hematocrit :", font=CTkFont('Kanit Regular',30))
...
MCV_label = CTkLabel(master=graphframe6, text="MCV :", font=CTkFont('Kanit Regular',30))
