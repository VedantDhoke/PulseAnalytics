...
title_label = CTkLabel(master=frame1, text="LP Form", font=CTkFont('Microsoft YaHei UI Light',35,"bold",underline="true"))
...
chl_label = CTkLabel(master=frame1, text="Cholesterol:", font=CTkFont('Kanit Regular',20))
chl_label.place(relx=0.1,rely=0.28)
chl_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
chl_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.28)

tgc_label = CTkLabel(master=frame1, text="Triglycerides:", font=CTkFont('Kanit Regular',20))
tgc_label.place(relx=0.1,rely=0.38)
tgc_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
tgc_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.38)

hdlc_label = CTkLabel(master=frame1, text="HDL cholesterol:", font=CTkFont('Kanit Regular',20))
hdlc_label.place(relx=0.1,rely=0.48)
hdlc_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
hdlc_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.48)

ldlc_label = CTkLabel(master=frame1, text="LDL cholesterol:", font=CTkFont('Kanit Regular',20))
ldlc_label.place(relx=0.1,rely=0.58)
ldlc_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
ldlc_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.58)

vldl_label = CTkLabel(master=frame1, text="VLDL cholesterol:", font=CTkFont('Kanit Regular',20))
vldl_label.place(relx=0.1,rely=0.68)
vldl_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="%d")
vldl_entry.place(relheight=0.05,relwidth=0.5,relx=0.4,rely=0.68)

nhdlc_label = CTkLabel(master=frame1, text="Non-HDL cholesterol:", font=CTkFont('Kanit Regular',20))
nhdlc_label.place(relx=0.1,rely=0.78)
nhdlc_entry = CTkEntry(master=frame1,corner_radius=12,fg_color="#FFFFFF",border_width=0,placeholder_text="tbd")
